<section class="section svg-back2" id="timeline">
    <header class="section-header">
        ...
        <h2 style="" class="text-grey-darkest">Schedule</h2>
    </header>
    <section id="cd-timeline" class="cd-container">
        ...
        <div class="cd-timeline-block" id="hannes">
            <a class="cd-timeline-img cd-picture" href="javascript:void(0)" data-scrollto="hannes">
        ...
        <div class="cd-timeline-block" id="sarthak">
            <a class="cd-timeline-img cd-picture" href="javascript:void(0)" data-scrollto="sarthak">
        ...
        <div class="cd-timeline-block" id="shawn">
            <a class="cd-timeline-img cd-picture" href="javascript:void(0)" data-scrollto="shawn">
            ...
            <div class="cd-timeline-content shadow-lg border-t-2 border-indigo-light bg-grey-lightest">
                ...
                <span class="cd-date">11:45 AM</span>
            </div>
            <!-- cd-timeline-content -->
        </div>
        <!-- cd-timeline-block -->
        ...
        <div class="cd-timeline-block" id="vaibhav">
            <a class="cd-timeline-img cd-picture" href="javascript:void(0)" data-scrollto="vaibhav">
        ...
        <div class="cd-timeline-block" id="freek">
            <a class="cd-timeline-img cd-picture" href="javascript:void(0)" data-scrollto="freek">
